...
public class ProductController {
    ...
    public static ModelAndView renderCategory(Request req, Response res) throws IOException, URISyntaxException {
    ...
    public static ModelAndView renderSupplier(Request req, Response res) throws IOException, URISyntaxException {
